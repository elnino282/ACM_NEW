...
import { useCreateFarm as useCreateFarmEntity, FarmCreateRequestSchema, type FarmCreateRequest } from '@/entities/farm';
import { toast } from 'sonner';

/**
 * Feature hook for creating a farm with form validation and toast handling
 */
export function useCreateFarm(onSuccessCallback?: () => void) {
