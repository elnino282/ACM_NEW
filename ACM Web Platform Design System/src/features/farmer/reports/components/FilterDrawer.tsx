...
export function FilterDrawer({
    ...
    return (
        <Sheet open={isOpen} onOpenChange={onOpenChange}>
            <SheetContent
                side="right"
                className="w-[320px] sm:max-w-[320px] overflow-y-auto border-l-2 border-[#4CAF50]/20"
            >
                <SheetHeader>
                ...
                <div className="mt-6 space-y-6">
                    <div className="space-y-2">
                        <Label htmlFor="plot-filter" className="text-[#333333]">
                            Plot Selector
                        </Label>
                        <Select>
                            <SelectTrigger
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="crop-filter" className="text-[#333333]">
                            Crop Type
                        </Label>
                        <Select
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="season-filter" className="text-[#333333]">
                            Season
                        </Label>
                        <Select
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="time-filter" className="text-[#333333]">
                            Time Range
                        </Label>
                        <Select
                    ...
                    <div className="flex items-center justify-between">
                        <Label htmlFor="closed-seasons" className="text-[#333333]">
                ...
                <div className="mt-8 flex gap-3">
                    <Button
                        variant="outline"
                        className="flex-1 rounded-xl border-[#E0E0E0]"
