...
export function CostTab() {
    return (
        <div className="space-y-6">
            <div>
                <h3 className="text-lg text-[#333333] mb-1">Cost Analysis</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Donut Chart */}
                <div>
                    <h4 className="text-sm text-[#333333] mb-4">Cost Distribution</h4>
                ...
                {/* Stacked Bar Chart */}
                <div>
                    <h4 className="text-sm text-[#333333] mb-4">Monthly Comparison</h4>
                    <ResponsiveContainer width="100%" height={350}>
                        <RechartsBarChart data={MONTHLY_COSTS}>
                            ...
                            />
                            <Legend />
                            <Bar dataKey="seeds" stackId="a" fill="#4CAF50" />
                            <Bar dataKey="fertilizer" stackId="a" fill="#81C784" />
                            <Bar dataKey="labor" stackId="a" fill="#FFB300" />
                            <Bar dataKey="fuel" stackId="a" fill="#506E73" />
                            <Bar dataKey="machinery" stackId="a" fill="#A5D6A7" />
                        </RechartsBarChart>
                    </ResponsiveContainer>
                </div>
            </div>
